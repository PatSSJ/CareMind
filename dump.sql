...
CREATE TABLE `alarmas` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_alarmas_persona` (`persona_id`),
  KEY `idx_alarmas_medicacion` (`medicacion_id`)
...
INSERT INTO `alarmas` VALUES (2,1,2,'2026-03-06 06:06:00',1),(3,3,3,'2026-03-07 20:30:00',0),(4,6,3,'2026-06-06 16:05:00',0);
...
CREATE TABLE `medicamentos` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_medicamentos_owner` (`owner_usuario_id`)
...
INSERT INTO `medicamentos` VALUES (1,'Clonazepam','Toda la caja de una.',1),(2,'Ibuprofeno','3',1),(3,'Ibuprofeno 600','2',3),(4,'Aspirinas','50',3),(5,'Paracetamol','3',3),(6,'Paracetamol','5',9);
...
CREATE TABLE `personas` (
  ...
  `owner_usuario_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_personas_owner` (`owner_usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `personas` VALUES (4,'Mariano','X45679323M','654321987','Enric Granados 39','123-456123789-34',8),(5,'Martin','R3456789O','666234567','Rambla Catalunya 4','123-456123789-38',4),(6,'Martin San Jose','N12345678Y','678789890','Valencia 234','000-111222333-70',3);
...
INSERT INTO `pines_temporales` VALUES (1,'705267','2026-03-03 04:38:22',0),(2,'449742','2026-03-03 06:16:29',1),(3,'316092','2026-03-04 16:27:22',0),(4,'189029','2026-03-04 16:27:44',0),(5,'865445','2026-03-04 16:28:20',0),(6,'840280','2026-03-04 16:28:59',0),(7,'344889','2026-03-04 16:46:04',1),(8,'418771','2026-03-04 17:44:49',1),(9,'434077','2026-03-04 17:46:40',1),(10,'511132','2026-03-05 01:05:37',0),(11,'897431','2026-03-05 01:05:37',0),(12,'551862','2026-03-05 01:05:37',0),(13,'461240','2026-03-05 01:05:48',1),(14,'415912','2026-03-06 00:50:20',1);
...
INSERT INTO `usuarios` VALUES (3,'Patricia San Jose','psanjose@institutmvm.cat','$2y$10$u77cDxKGrJMeukn2arxMDOAn5pSMYw9ivhY1xogBSlUuFgjWWUKi2',1,NULL),(4,'Patricia San Jose 2','patriciasoramasanjose@gmail.com','$2y$10$za1LbHsGle8Z02INtiFbpOuNQKn1LmqZAdPtZ8wLaI4.z4ZzBPMp.',1,NULL),(5,'Alejandro Sucilla','asucilla@institutmvm.cat','$2y$10$Z3NRjqKhHpEQTpMQzQIwy.G.DZcf5rkXhD0.uHGFvtWgEI0DLO8Du',1,NULL),(6,'Aurelio Gomez','aureliogomez@gmail.com','$2y$10$JO58ae1sL5k9FuQXj/f8X.hKP3XAxsUYWqrI18SH06/Q5ElOLpeIy',1,NULL),(7,'Maria Manola Perez','mariamanolaperez@gmail.com','$2y$10$dUFbmOBh09t/YfrdVcdymOaYeLEt40nUexSBuyEXeFGWau1yc5E6W',1,NULL),(8,'Margarita Lopez','margaritalopez@gmail.com','$2y$10$1yhRe056wQ3TrD5fQOhUZen0hJcxcobEJQUoGfWTdLeMMar20rc/6',1,NULL),(9,'Osvaldo','osvaldo@gmail.com','$2y$10$m2ShXX.uFXLXRHKonp0ntuvd/tqyQxBusYliRal6Z24LAYvts1nKq',1,NULL);
...
-- Dump completed on 2026-03-06 13:29:53
