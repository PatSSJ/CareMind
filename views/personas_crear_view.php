...
<div class="contenedor">
    <div class="columna">
        ...
        <p>
            <a class="btn btn-secondary btn-sm" href="index.php?controller=personas&action=listado">
                Volver al listado
            </a>
        </p>
        ...
        <form method="post" action="index.php?controller=personas&action=crear">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="num_seguridad_social" required>
            </div>
